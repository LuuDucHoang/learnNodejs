...
router.post('/getUserAction', homeController.getUserAction)
router.post('/updateUserAction', homeController.updateUserAction)
router.post('/getUserActionDetail', homeController.getUserActionDetail)
router.post('/insertUserAction', homeController.insertUserAction)
router.post('/deleteUserAction', homeController.deleteUserAction)
